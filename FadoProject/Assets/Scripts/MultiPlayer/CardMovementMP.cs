...
public class CardMovementMP : MonoBehaviour, IDragHandler, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
	...
	public CardDisplayMP currentCardDisplay;
	...
	void Awake() 
	{
		...
		currentCardDisplay = gameObject.GetComponent<CardDisplayMP>();
	}
            ...
            case 3:
				...
				switch (currentCard.cardType)
				{
					...
					case CardType.Poison:
                        ...
                        GameManagerMP.Instance.inPlay = true;
                        TargetHandlerMP.Instance.usedCardAction += removeTargetCard;

                        TargetHandlerMP.Instance.SetTargetConfig(currentCard);
						break;
				}
                break;
		}
	...
	{
		popup.actionRemoveCard -= removeCard;
		HandManagerMP handManager = FindAnyObjectByType<HandManagerMP>();
	...
	private void HandlePlayState()
	{
		...
		{
            GameManagerMP.Instance.inPlay = false;
			TargetHandlerMP.Instance.usedCardAction -= removeTargetCard;
			AudioManager.Instance.PlayOneShot(FMODEvents.Instance.Snap, gameObject.transform.localPosition);
