...
public class PopupMP : MonoBehaviour
{
	...
	{
        corruptionText.text = GameManagerMP.Instance.mainPlayer.Corruption.ToString();
        poisonText.text     = GameManagerMP.Instance.mainPlayer.Poison.ToString();
        moraleText.text		= GameManagerMP.Instance.mainPlayer.Morale.ToString();
        influenceText.text	= GameManagerMP.Instance.mainPlayer.Influence.ToString();
    ...
    public void EndGamePopup(EndCondition endCondition)
    {
        ...
        if (endCondition == EndCondition.SP_PlayerDead)
        {
            ...
            switch ((coinToss, GameManagerMP.Instance.mainRole))
            {
                case (0, Roles.Honest):
        ...
        switch((endCondition, GameManagerMP.Instance.mainRole))
        {
